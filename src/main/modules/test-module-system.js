...
async function runTests() {
    ...
    await test('RAR formatı 7za kısıtı nedeniyle desteklenmemeli (node-unrar-js gerektirir)', () => {
        assert(archive.supportsFormat('.rar') === false);
    });
    ...
    await test('getSupportedFormats dizisi .zip ve .7z içermeli', () => {
